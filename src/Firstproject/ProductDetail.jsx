...
function ProductDetail() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-cyan-800 py-8">
        ...
        <div className="flex flex-col md:flex-row -mx-4">
          ...
          <div className="md:flex-1 px-4">
            ...
            <div className="flex mb-4">
              ...
              <div>
                <span className="font-bold text-gray-700 dark:text-gray-300">{product.stock} </span>
            ...
            <p className="text-gray-600 dark:text-green-400 text-sm mt-2"> {product.description}
              </p>
            </div>
          </div>
        </div>
